...
var DiscreteWavelets = /** @class */ (function () {
    ...
    DiscreteWavelets.wavedec2 = function (data, wavelet, padding, level, allowDimensionDowngrade) {
        ...
        for (var level_1 = 0; level_1 < numLevels; level_1++) {
            ...
            var bandsContaminationMask = this.dwt2(currentContaminationMask, wavelet, padding, 'taintAnalysisContamination'); // Perform taint analysis to detect coefficients affected by edges
        ...
        return { coeffs: coeffs, syntheticityMask: syntheticityMask, contaminationMask: contaminationMask };
    };
    /**
    ...
    DiscreteWavelets.pad = function (data, padWidths, padding) {
        ...
        /* Add padding. */
        return (0, helpers_1.createArray)(front, function (index) { return (0, helpers_1.padElement)(data, front - 1 - index, true, padding); })
            .concat(data)
            .concat((0, helpers_1.createArray)(back, function (index) { return (0, helpers_1.padElement)(data, index, false, padding); }));
    };
    /**
